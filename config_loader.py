...
class Config:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning(
                f"[WARN] Config file not found at {self.config_path}, using defaults"
            )
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "focus": {"focused_threshold": 80, "distracted_threshold": 50},
            "eye_tracking": {"screen_width": 1920, "screen_height": 1080},
            "privacy": {"allow_pause": True, "local_processing_only": True},
    ...
    def gpu_fallback_enabled(self) -> bool:
        return self.get(
            "performance", "gpu_acceleration", "fallback_to_cpu", default=True
        )
    ...
    def face_stability_threshold(self) -> float:
        return self.get(
            "performance", "selective_face_mesh", "stability_threshold", default=0.8
        )
